...
/**
 * Metrics Page
 * Centralized statistics dashboard for workorders and stubs
 */
    ...
    <PageLayout>
      <PageCard>
        <div className="space-y-6 sm:space-y-8">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-ind-text mb-2">Metrics</h1>
            <p className="text-xs sm:text-sm md:text-base text-ind-text-muted">
              Aggregated statistics for workorders and stubs across all projects.
            </p>
          </div>
