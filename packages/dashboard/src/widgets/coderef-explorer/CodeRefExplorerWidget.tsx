...
export function CodeRefExplorerWidget() {
  ...
  return (
    <div className="h-full flex overflow-hidden bg-ind-bg">
      {/* Page Sidebar - extends to top - flex-shrink-0 prevents width expansion from long file names */}
      <div className="w-80 flex-shrink-0 border-r border-ind-border bg-ind-panel flex flex-col">
        {/* Controls section */}
